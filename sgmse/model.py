...
class ScoreModel(pl.LightningModule):
    ...
    def add_argparse_args(parser):
        ...
        parser.add_argument(
            ...
            type=str,
            default=None,
            help="The type of loss scaling to use.",
        )
        parser.add_argument(
            "--c_in", type=str, default="1", help="The input scaling for x."
        )
        parser.add_argument(
            "--c_out", type=str, default="1", help="The output scaling."
        )
        parser.add_argument(
            "--c_skip", type=str, default="0", help="The skip connection scaling."
        )
        parser.add_argument(
            "--sigma_data", type=float, default=0.1, help="The data standard deviation."
        )
        parser.add_argument(
            "--l1_weight",
            type=float,
    ...
    def validation_step(self, batch, batch_idx):
        ...
        if batch_idx == 0 and self.num_eval_files != 0:
            ...
            for clean_file, noisy_file in zip(clean_files, noisy_files):
                ...
                assert (
                    sr_x == sr_y
                ), "Sample rates of clean and noisy files do not match!"
                ...
                if self.sr != 16000:
                    x_hat_16k = resample(
                        x_hat, orig_sr=self.sr, target_sr=16000
                    ).squeeze()
                else:
                    x_hat_16k = x_hat
